...
const PATHWAYS = [
  {
    ...
    descriptor: "Catch what routine visits usually miss.",
    bullets: [
  ...
  },
  {
    ...
    tag: "Pathway 05",
    title: "Longevity",
    descriptor: "Where oral-systemic medicine meets regenerative therapy.",
    bullets: [
      "100+ biomarker and biological-age baseline",
      "Peptide and regenerative therapy",
      "Cellular longevity and oral-aging protocols",
      "Clinically supervised, biomarker-guided plans",
    ],
    color: B.navy,
