...
const FAQ_ITEMS = [
  ...
  { q: "Will I need to do anything to prepare?", a: "We send a pre-visit protocol that includes hydration guidance and dietary suggestions to support the body's natural clearance pathways. Some patients also choose to work with a functional or integrative physician on a chelation or nutritional protocol around the time of removal — we can refer if you'd like." },
  ...
  return (
    <>
      ...
      <ArticleContainer>
        ...
        <p>
          We do material-sensitivity testing (MELISA) when there's a clinical reason — autoimmune history,
