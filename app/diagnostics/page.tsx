...
const DIMS = [
  ...
  },
  {
    ...
    intro: "Your dentist can detect sleep apnea before any other clinician. Find out what your airway is telling us.",
    ...
    <div style={{ minHeight: "100vh", background: B.navy, padding: "40px 24px 60px", overflow: "auto" }}>
      ...
      <div style={{ maxWidth: 560, margin: "0 auto" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 20, padding: "28px 24px", textAlign: "center" }}>
          ...
          <a href="https://primaryid.com/book" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, padding: "15px", background: B.blue, color: B.white, borderRadius: 12, fontFamily: "Georgia,serif", fontSize: 15, textDecoration: "none", marginBottom: 10, boxShadow: `0 4px 20px ${B.blue}40`, transition: "all 0.25s ease" }}
            onMouseOver={e => { e.currentTarget.style.transform = "translateY(-2px)"; }}
            onMouseOut={e => { e.currentTarget.style.transform = "translateY(0)"; }}
          >
